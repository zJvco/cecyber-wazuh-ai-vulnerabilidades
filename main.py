...
WAZUH_INDEXER_AUTH_USER = "admin"
WAZUH_INDEXER_AUTH_PASS = "HiC+B76aJw3sdBBE1X*FRmQ7xarUqXTg"
WAZUH_INDEXER_HOST = "10.200.150.26"
...
googleai_client = genai.Client(
    api_key="AIzaSyAOs2J2riceO2EEWWLr9OOuGfysmV7DKiI"
)
...
for vuln in vulnerabilities:
    if vuln["_source"]["vulnerability"]["id"] == "CVE-2025-33073":
        ...
        print(f"\033[91mSeveridade\033[0m: {vuln["_source"]["vulnerability"]["severity"]}")
